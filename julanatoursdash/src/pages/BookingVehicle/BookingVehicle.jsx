...
// import './BookingVehicle.css'; // Assuming you have a CSS file for styling
...
//                                              >-</button>
//                                             <input style={{ "maxWidth": "100px" }} type="text" className="form-control  form-control-sm text-center quantity-input" value={quantities[vehicle.id]} readOnly />
//                                             <button className="btn btn-outline-secondary btn-sm" type="button"
...
//                                         <button className="btn btn-sm btn-outline-danger" onClick={() => removeFromBookingVehicle(vehicle.id)}>
...
//                     <div className="d-flex justify-content-between mb-3">
//                         <span>Pickup</span>
//                         <span>Rs.{subtotal == 0 ? 0.0 : pickup.toFixed(2)}</span>
//                     </div>
//                     <div className="d-flex justify-content-between mb-3">
//                         <span>Tax</span>
...
//                     </div>
//                     <button className="btn btn-primary w-100" disabled={bookingItems.length === 0} onClick={() => navigate("/order")}>Proceed to Checkout</button>
//                 </div>
//             </div>
