...
export const ContactUs = () => {
  ...
  const EMAILJS_PUBLIC_KEY = '65opMa8TIfnJzzf-8'; // e.g., 'user_xxxxxxxxx'
  const EMAILJS_SERVICE_ID = 'service_usgk05x'; // e.g., 'service_xxxxxxx'
  const EMAILJS_TEMPLATE_ID = 'template_9wz36vn'; // e.g., 'template_xxxxxxx'
...
//   const EMAILJS_PUBLIC_KEY = 'YOUR_PUBLIC_KEY'; // e.g., 'user_xxxxxxxxx'
...
//         to_name: 'Julana Tours', // Your business name
